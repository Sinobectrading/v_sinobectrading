...
<div class="banner-bottom">
	<div class="container" id="homepro">
		<div class="wthree_head_section">
			<h3 class="w3l_header w3_agileits_header two">What <span> We Offer</span></h3>
		</div>
				...
				<div class="agileinfo_banner_bottom_pos">
					<div class="w3_agileits_banner_bottom_pos_grid two">
						...
						<div class="col-xs-9 wthree_banner_bottom_grid_right">
							...
							<p>Aim to reduce client’s total cost of ownership with competitive purchasing cost and short lead time; VMI, Consignment and provide flexibility. </p>
							<!-- <div class="agileits-button two service">
								<a class="btn btn-primary btn-lg hvr-underline-from-left" href="single.html" role="button">Read More »</a>
							</div> -->
						</div>
